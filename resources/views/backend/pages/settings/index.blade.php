    ...
    <div class="row">
                ...
                <ul class="list-group list-group-flush">
                    @foreach($settings_sections as $settings_section)
                        <li class="list-group-item">
                            <a href="{{ route('settings.index', ['section' => $settings_section]) }}" class="nav-link"><i class="fa fa-gear"></i> {{ $settings_section }}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
        ...
        <div class="col-9">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::model($settings, ['route' => ['settings.update', 1], 'method' => 'patch']) !!}
