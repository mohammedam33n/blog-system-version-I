...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        @include('backend.pages.users.filter.filter')
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                @forelse($users as $user)
                    <tr>
                        <td>
                            <img src="{{ asset(path('users',$user->user_image)) }}" width="60">
                        </td>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <form action="{{ route('users.destroy', $user->id) }}" method="post" id="user-delete-{{ $user->id }}" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </div>
