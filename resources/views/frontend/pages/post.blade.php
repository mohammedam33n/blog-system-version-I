                        ...
                        <div class="carousel-inner">
                            @foreach ($post->media as $media)
                                <div class="carousel-item {{ $loop->index == 0 ? 'active' : '' }}">
                                    <img class="d-block w-100" src="{{ asset('images/posts/' . $media->file_name) }}"
                                        alt="{{ $post->title }}">
                                </div>
                            @endforeach
                        </div>
                    ...
                    @forelse ($post->approved_comments as $comment)
                        <li>
                            <div class="wn__comment">
                                ...
                                <div class="thumb">
                                    <img src="{{ get_gravatar($comment->email, 60) }}" alt="comment images">
                                </div>
            ...
            <div class="comment_respond">
                ...
                <div class="input__wrapper clearfix">
                    ...
                    <div class="input__box website one--third">
                        {!! Form::text('website', old('website'), ['placeholder' => 'website']) !!}
                        @error('website')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
