                ...
                <tbody>
                    @forelse($posts as $post)
                        <tr>
                            <td>{{ $post->title }}</td>
                            <td>
                                {{-- <a href="{{ route('comment.edit', ['post' => $post->id]) }}">{{ $post->comments_count }}</a> --}}
                                <a href="{{ route('comment.show', $post->id) }}">{{ $post->comments_count }}</a>
                                {{-- <a href="{{ route('comment.show', ['slug' => 'someslug']) }}">{{ $post->comments_count }}</a> --}}
