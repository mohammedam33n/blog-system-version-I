...
class UserController extends Controller
{
    ...
    {
        $posts = auth()->user()->posts()->with(['media', 'category', 'user'])->withCount('comments')->orderBy('id', 'desc')->paginate(5);
        // $posts = Post::whereUserId(auth()->user()->id)->with(['media', 'category', 'comments', 'user'])->withCount('comments')->orderBy('id', 'desc')->paginate(5);
        return view('frontend.pages.users.dashboard', compact('posts'));
    }

    public function edit_info()
    {
        // dd('hmada');
        return view('frontend.pages.users.edit_info');
    }
    ...
    public function create_post()
    {
        ...
        return view('frontend.pages.users.create_post', compact('categories'));
    }
    ...
    public function edit_post($post_id)
    {
        ...
        $post = Post::with(['media'])->whereSlug($post_id)->orWhere('id', $post_id)->whereUserId(auth()->id())->first();

        if (isset($post)) {
            return view('frontend.pages.users.edit_post', compact('categories', 'post'));
        }
    ...
    public function show_comments(Request $request)
    {
        ...
        return view('frontend.pages.users.comments', compact('comments'));
    }
    ...
    public function edit_comment($comment_id)
    {
        ...
        if ($comment) {
            return view('frontend.pages.users.edit_comment', compact('comment'));
        } else {
            return redirect()->back()->with([
                'message' => 'Something was wrong',
                'alert-type' => 'danger',
